...
;addi x4, x0, 0x115 ; bit endian=1, CPHA=1, SPI enable=1
...
addi x4, x0, 0x001 ; command length = 1
...
addi x4, x0, 0x005 ; data length = 5
...
addi x4, x0, 0x1 ; SPI run = 1, read/wirte = 0 (read)
