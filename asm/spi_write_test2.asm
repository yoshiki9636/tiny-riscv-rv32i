...
addi x4, x0, 0x317 ; bit endian=1, CPHA=0, SPI enable=1
...
;slli x4, x4, 16 ; shift left 8 bit
...
lui x4, 0xf0e0d ; data0 high
addi x4, x4, 0x0c0 ; data0 low
sw x4, 0x0(x3) ; set value to command data0 reg

lui x4, 0xb0a09 ; data1 high
addi x4, x4, 0x080 ; data1 low
sw x4, 0x4(x3) ; set value to command data1 reg

lui x4, 0x70605 ; data3 high
addi x4, x4, 0x040 ; data3 low
sw x4, 0x8(x3) ; set value to command data2 reg

lui x4, 0x30201 ; data2 high
addi x4, x4, 0x0ff ; data2 low
