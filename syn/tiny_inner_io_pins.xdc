...
set_property IOSTANDARD LVCMOS33 [get_ports gpi_in]
set_property PACKAGE_PIN C10 [get_ports gpi_in]
...
set_input_delay -clock [get_clocks -of_objects [get_nets clk]] -min -add_delay 1.000 [get_ports gpi_in]
set_input_delay -clock [get_clocks -of_objects [get_nets clk]] -max -add_delay 1.000 [get_ports gpi_in]
