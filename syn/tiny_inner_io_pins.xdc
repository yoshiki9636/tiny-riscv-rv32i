set_property OFFCHIP_TERM NONE [get_ports rgb_led[3]]
...
set_property DRIVE 12 [get_ports {rgb_led[3]}]
...
set_property SLEW SLOW [get_ports {rgb_led[3]}]
...
set_property PACKAGE_PIN G4 [get_ports {rgb_led[3]}]
